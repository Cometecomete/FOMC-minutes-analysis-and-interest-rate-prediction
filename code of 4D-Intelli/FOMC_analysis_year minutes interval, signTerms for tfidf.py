...
tfidf_IR_year = tfidf_IR_diff.groupby(['year'],as_index=False).mean()

tfidf_IR_year['rateChange'] = tfidf_IR_year['fedRate'].shift(-1) - tfidf_IR_year['fedRate']
...
tfidf_IR_diff = tfidf_IR_year.dropna()

tfidf_IR_diff=tfidf_IR_diff.drop(['month','day','file_name','content'],axis=1)
tfidf_IR_diff.sort_values(by=['year','rateChange'],ascending = True)
...
words = tfidf_IR_diff.columns[4:-1]
