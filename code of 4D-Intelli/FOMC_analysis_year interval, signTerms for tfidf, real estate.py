##year minutes interval, signTerms for tfidf, real estate
import os
from dfply import *
import pandas as pd
import re
...
bow_IR_year['rateChange'] = bow_IR_year['WILLREITIND'].shift(-1) - bow_IR_year['WILLREITIND']
...
bow_IR_diff = bow_IR_year.dropna()

bow_IR_diff=bow_IR_diff.drop(['Unnamed: 0','month','day','file_name','content'],axis=1)
bow_IR_diff.sort_values(by=['year','rateChange'],ascending = True)
